...
//  NewTimer
//
//  Created by Марина Айбулатова on 01.04.2021.
//
...
class AllListViewController: UITableViewController, ListDetailViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        list = Checklist(name: "trip")
        lists.append(list)
        
        list = Checklist(name: "books")
        lists.append(list)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ShowChecklist" {
            let controller = segue.destination as! TableExercisesViewController
